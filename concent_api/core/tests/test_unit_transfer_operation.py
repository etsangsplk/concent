...
class FileTransferTokenCreationTest(TestCase):
    ...
    def test_that_file_transfer_token_for_concent_is_never_out_of_date(self):
        ...
        token = create_file_transfer_token_for_concent(
            ...
            get_storage_source_file_path(report_computed_task.task_id, report_computed_task.subtask_id),
            report_computed_task.task_to_compute.size,
            report_computed_task.task_to_compute.package_hash,
            get_storage_result_file_path(report_computed_task.task_id, report_computed_task.subtask_id),
