...
def test_case_1_test_for_positive_case(cluster_consts, cluster_url, test_id):
    ...
    file_content_1 = task_id
    file_content_2 = subtask_id
    file_size_1 = len(file_content_1)
    file_size_2 = len(file_content_2)
    file_check_sum_1 = 'sha1:' + hashlib.sha1(file_content_1.encode()).hexdigest()
    file_check_sum_2 = 'sha1:' + hashlib.sha1(file_content_2.encode()).hexdigest()
    ...
    ack_subtask_results_verify = api_request(
        ...
        get_subtask_results_verify(
            ...
            report_computed_task_size=file_size_1,
            report_computed_task_package_hash=file_check_sum_1,
            task_to_compute_size=file_size_2,
